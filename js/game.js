...
class Player extends Sprite {
    ...
    update() {
        ...
        // console.log(this.x);
        // the square will stop when it collides with the wall from the left or from the right
        ...
        // the square will stop when it collides with the wall from up or from down
